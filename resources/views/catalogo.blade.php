...
<html lang="en">
	...
	<body>
		...
		<div class="container">
	   		<h1 align="center" >Productos a la venta</h1>
						...
						<div class="">
							...
							<div class="card">
								<div class="card-image">
									<img class="activator" src="{{ $producto->imagen }}" height= "300px" width="300px"  >
								</div>
								<div class="card-content">
									<p>{{ ucwords($producto->nombre) }}</p>
									<p>{{ $producto->precio }} c/u</p>
									<a class="btn-floating halfway-fab waves-effect waves-light red pulse add-to-cart" href="#" data-name="{{ ucwords($producto->nombre) }}" data-price="{{ $producto->precio }}" data-id="{{ $producto->id }}" data-categoria="{{ $producto->id_categoria }}"><i class="material-icons">shopping_cart</i></a>
								</div>
