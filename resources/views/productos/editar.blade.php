...
if($id != 0){
	...
	$categoria2 = $producto->id_categoria;
	$img = $producto->imagen;
}
	...
	<body>
		...
		<div id="index-banner" class="parallax-container">
			<div class="section no-pad-bot">
				<div class="container">
					<br><br>
					<h1 class="header center white-text lighten-5">MODIFICADOR DE PRODUCTOS</h1>
					<div class="row center">
						<h5 class="header center white-text col s12 lighten-5">Modifica productos con sus imagenes.</h5>
					</div>
					<br><br>
				</div>
			</div>
		...
		<div class="container">
			<section>
				...
				{!! Form::open(['route' => 'editarproducto', 'method' => 'POST', 'id' => 'crearForm', 'files'=>true,]) !!}
					...
					<div class="row uniform">
						...
						<div class="input-field"> 
							<input type="text" name="descripcion" id="descripcion" class="validate" value='{{ $descripcion }}' />
						...
						<div class="input-field"> 
							<input type="number" min="1" step="any" name="precio" id="precio" class="validate" value='{{ $precio }}'/>
						...
						<div class="input-field">
							...
							<div class="row uniform">
								...
								@foreach($categorias as $categoria)
									@if($categoria->id == $categoria2)
									
								<div class="col s3">
									<label>
										<input class="with-gap" name="categoria" type="radio" value="{{ $categoria->id }}" id="categoria" checked/>
					...
					<div class="12u$">
						<ul class="actions" style="text-align: center">
							<li><input type="button" value="modificar" class="waves-effect waves-light btn" id="crear"/></li>
						</ul>
					</div>
	  ...
	  <!--  Scripts-->
		...
		<script type="text/javascript">
			...
			$('#crear').click(() => {
				...
				if($('#nombre').val() != '' && $('#descripcion').val() != '' && $('#precio').val() != '' && $('input[name="categoria"]:radio').is(':checked') )
					$('#crearForm').submit()
			})
