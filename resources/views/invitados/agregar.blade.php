						...
						<section>
							...
							{!! Form::open(['route' => 'agregarinvitado', 'method' => 'POST', 'id' => 'agregar-form_id', 'class' => 'panel']) !!}
								...
								<div class="row uniform">
									...
									<div class="12u 12u$(xsmall)">
										<input type="text" name="nombre" id="nombre" value="" placeholder="Nombre(s) invitado" />
									</div>

									<div class="12u$ 12u$(xsmall)">
										<input type="text" name="apellido"  id="apellido" value="" placeholder="Apellido(s) invitado" />
									</div>
