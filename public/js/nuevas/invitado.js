...
function getRowSelected(objectPressed){
	...
	var direccion=a.getElementsByTagName("td")[2].getElementsByTagName("p")[0].innerHTML;
	

	var array_fila = [nombre,apellido,direccion];
...
function newRowTable()
{
    ...
    cell2.innerHTML = '<p name="codigo_Invitado[]" class="non-margin">'+'<a href="#" id="data">'+apellido+'</a>'+'</p>';
    cell3.innerHTML = '<p name="direccion[]" class="non-margin">'+'<a href="#" id="data">'+direccion+'</a>'+'</p>';
    cell4.innerHTML = '<span class="icon fa-edit"><i class="small material-icons">edit</i></span><span class="icon fa-eraser"><i class="small material-icons">   close</i></span>';
